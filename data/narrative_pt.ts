...
const pt_translation = {
    ...
    ui: {
        ...
        menuTagline: "Lutar ou dançar. Sombra ou canção.",
        choosePath: "Escolha o seu caminho",
        lastPlayed: "Última partida",
        recommended: "Recomendado",
        difficultyNormal: "Normal",
        difficultyHard: "Difícil",
        difficultyRequiem: "Réquiem",
        difficultyNormalTitle: "A Errância",
        difficultyNormalDesc: "O labirinto é paciente. Aprenda o seu ritmo. Fugir ainda é gentil.",
        difficultyHardTitle: "O Caminho de Espinhos",
        difficultyHardDesc: "Os espíritos golpeiam mais forte. A dança acelera. A piedade rareia.",
        difficultyRequiemTitle: "A Última Canção",
        difficultyRequiemDesc: "Sem trégua. Cada hesitação é lembrada.",
